				...
				{selected &&
					<div className="selected-content-div" >
						...
						<button onClick={()=>setSelected(false)} > X</button>
							<img src={`https://image.tmdb.org/t/p/w500/${selectedContent.poster_path}`} alt="couldn't find" />
							<div>
							<h2>{selectedContent.title.toUpperCase()} {`(${selectedContent.release_date.slice(0,4)})`} </h2>
